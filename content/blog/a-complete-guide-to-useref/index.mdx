...
The button below is completely interactive, try clicking the first button and then Re-render.
</Alert>
...
see what happens. Below is the exact same button with another button that
