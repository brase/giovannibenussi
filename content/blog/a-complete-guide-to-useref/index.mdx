...
<OutsideVariableMultiple refs={2} />
...
'Today': [
    ...
    { message: "Hey, what's up?", side: 'left', time: '12:00'},
    { message: "Could you give me a reference to this dom node?", side: 'right', time: '12:00' },
    { message: "Sure, I assigned it to the 'current' property of your ref.", side: 'left', time:'12:00' },
